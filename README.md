# Antigravity Fedora RPM Repository & Launcher

Antigravity is the launcher utility for the Antigravity workspace IDE on Fedora. This repository hosts the Fedora RPM package packaging configuration, build scripts, and publish scripts.

It installs system-wide launcher integration, registers the `.desktop` launcher, and handles downloading and caching the latest binary packages from Google Cloud Storage on install.

---

## Installation Instructions

You can set up the repository and install Antigravity on your Fedora system in one of two ways:
...
Once installed, you can launch Antigravity in two ways:
1. **Application Grid**: Click the **Antigravity** icon in your desktop environment launcher.
